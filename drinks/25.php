...
<!-- 
						...
						<div class="box alt">
								<div class="row 50% uniform">
									<div class="12u$"><span class="image fit"><img src="../assets/images/thumbs/25.png" alt="" /></span></div>
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 25"); 
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Put all the ingredients in a pot and turn on the heat.</p>
							<h4>Step 2</h4>
							<p>Bring it to a boil, and simmer them for 3 to 5 minutes over low heat.</p>
							<h4>Step 3</h4>
							<p>All done. You can eat everything in the bowl!</p>
	</section>

...
<!-- 
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 20"); 
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Brew espresso. Fill a 12 - 16 ounce glass 3/4 the way up with ice.</p>
							<h4>Step 2</h4>
							<p>Pour water into the glass, followed by brewed espresso, and stir.</p>
	</section>

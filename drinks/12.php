...
<!-- 
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 12"); 
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Warm the water and 1/3 cup honey in a pot or saucepan over low heat. Stir to dissolve the honey and once dissolved, remove from the heat. This should only take about a minute.</p>
							<h4>Step 2</h4>
							<p>Add the lemon juice and stir. Add more honey, if desired.</p>
							<h4>Step 3</h4>
							<p>Chill and serve.</p>
	</section>

...
<!-- 
						...
						<div class="box alt">
								<div class="row 50% uniform">
									<div class="12u$"><span class="image fit"><img src="../assets/images/thumbs/13.png" alt="" /></span></div>
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 13"); 
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Steep green tea in a mixing cup or shaker cup.</p>
							<h4>Step 2</h4>
							<p>Pour in Matcha Powder, Golden Cane Sugar Syrup, Stir or Shake.</p>
							<h4>Step 3</h4>
							<p>Pour into serving cup filled with red bean and ice.</p>
							<h4>Step 4</h4>
							<p>Top with dash of milk. Serve with straw and spoon! Yum!</p>
	</section>

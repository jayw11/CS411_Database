...
<!-- 
						...
						<div class="box alt">
								<div class="row 50% uniform">
									<div class="12u$"><span class="image fit"><img src="../assets/images/thumbs/6.png" alt="" /></span></div>
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 5"); 
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Place ground coffee in the filter of a drip coffeemaker.</p>
							<h4>Step 2</h4>
							<p>Add water; brew according to manufacturer's instructions.</p>
							<h4>Step 3</h4>
							<p>TServe immediately in espresso cups with lemon twists if desired.</p>
	</section>

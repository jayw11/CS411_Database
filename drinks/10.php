...
<!-- 
						...
						<div class="box alt">
								<div class="row 50% uniform">
									<div class="12u$"><span class="image fit"><img src="../assets/images/thumbs/10.png" alt="" /></span></div>
	...
	<div class="table-wrapper">
		...
		<tbody>
			<?php
					...
					$result = mysqli_query($link, "select distinct `storeName`, `price` from `sells` natural join `stores` where `drinkID` = 10"); 

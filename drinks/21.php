...
<!-- 
						...
						<div class="box alt">
								<div class="row 50% uniform">
									<div class="12u$"><span class="image fit"><img src="../assets/images/thumbs/21.png" alt="" /></span></div>
	...
	<section>
						<h2>Recipe</h2>
							...
							<h4>Step 1</h4>
							<p>Steep the tea bags in hot water until the color turns dark red, about 3 to 5 minutes. Discard the tea bags and let the tea cool.</p>
							<h4>Step 2</h4>
							<p>Combine the ice cubes, sweetened condensed milk, and honey in a glass or cocktail shaker. Pour in the tea and mix well. (If the tea is still warm, the ice may melt; add more ice if desired.) A strong, flavorful milk tea is ready for you to enjoy.</p>
	</section>
